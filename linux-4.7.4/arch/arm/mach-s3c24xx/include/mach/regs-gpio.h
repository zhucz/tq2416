...
#define S3C2416_GPCCON	   S3C2410_GPIOREG(0x20)
#define S3C2416_GPCDAT	   S3C2410_GPIOREG(0x24)
#define S3C2416_GPCUP	   S3C2410_GPIOREG(0x28)

#define S3C2416_GPDCON	   S3C2410_GPIOREG(0x30)
#define S3C2416_GPDDAT	   S3C2410_GPIOREG(0x34)
#define S3C2416_GPDUP	   S3C2410_GPIOREG(0x38)
