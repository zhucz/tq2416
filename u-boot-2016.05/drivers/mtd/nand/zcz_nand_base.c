...
//printk("Nand ECC type is NAND_ECC_HW_OOB_FIRST\n");
	...
	case NAND_ECC_HW:
//printk("Nand ECC type is NAND_ECC_HW\n");
...
//printk("Nand ECC type is  NAND_ECC_HW_SYNDROME\n");
		if ((!chip->ecc.calculate || !chip->ecc.correct ||
		     !chip->ecc.hwctl) &&
		    (!chip->ecc.read_page ||
		     chip->ecc.read_page == nand_read_page_hwecc ||
	...
	case NAND_ECC_SOFT:
//printk("Nand ECC type is NAND_ECC_SOFT\n");
	...
	case NAND_ECC_NONE:
//printk("Nand ECC type is NAND_ECC_NONE\n");
